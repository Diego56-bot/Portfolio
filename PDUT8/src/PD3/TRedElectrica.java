...
public class TRedElectrica extends TGrafoNoDirigido implements IRedElectrica{

    public TRedElectrica(Collection<TVertice> vertices, Collection<TArista> aristas) {
